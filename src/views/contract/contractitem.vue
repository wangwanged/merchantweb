	...
	<div class="container">
		<div class="header">
			<div class="header_top">
				...
				<div v-if="contractList.checkStatus === '0'">
					<el-button size="small" type="primary" @click="dialog.dialogcheck = true">审核</el-button>
					<el-button size="small" type="primary" @click="dialog.dialogextend = true">续签</el-button>
					<el-button size="small" type="primary" @click="handleEdit">编辑</el-button>
					<el-button size="small" type="primary" @click="handleTransfer">转移</el-button>
					<el-button size="small" type="primary" @click="dialog.dialogbreakoff = true">解约</el-button>
					<el-button size="small" type="primary" @click="dialog.dialoginvalid = true">失效</el-button>
				</div>
				<div v-if="contractList.checkStatus === '1'">
					<el-button size="small" type="primary" @click="dialog.dialoguncheck = true">反审核</el-button>
					<el-button size="small" type="primary" @click="dialog.dialogextend = true">续签</el-button>
					<el-button size="small" type="primary" @click="handleTransfer">转移</el-button>
					<el-button size="small" type="primary" @click="dialog.dialogbreakoff = true">解约</el-button>
				</div>
			...
			<div class="header_bottom">
				...
				<el-button type="primary" plain size="small" style="margin-right:15px">{{ dict.contractTypeLabel }}</el-button>
		...
		<div class="main">
			<div class="main_left">
				<el-tabs v-model="showTabs" class="tabs">
							...
							<div class="main_left" style="width:100%">
								<div class="main_content_top">
									...
									<el-table border :data="relatedList" style="width: 100%">
										<el-table-column prop="num" label="关联合同" min-width="170">
										</el-table-column>
										<el-table-column prop="type" label="合同类型" :formatter="contractTypeFormat" min-width="70">
										</el-table-column>
										<el-table-column prop="dianmianName" label="店面名称" min-width="170">
										</el-table-column>
									...
									<p class="main_content_name">
										...
										<span>{{ contractList.dianmianProvince }}
									...
									<p class="main_content_name">
										...
										<span>{{ contractList.dianmianLatitude }}
					...
					<el-tab-pane label="费用信息" name="second">
							...
							<div class="main_left" style="width:100%">
								<div class="main_content_top">
									<el-row type="flex" justify="space-around" style="margin-top:30px">
										...
										<el-button type="primary" size="small" @click="handleAddfee" v-if="contractList.checkStatus !== '2'">新增费用</el-button>
									</el-row>
									<el-row :gutter="20" type="flex" justify="space-around" style="margin-top:40px;font-size:13px;text-align:center">
										<el-col :span="3" v-for="(item, index) in feeList" :key="index">
											<p>{{ item.amount }}</p>
											<p>{{ item.type }}</p>
										</el-col>
									</el-row>
									<el-table :data="feeList" border style="width: 100%;margin-top:40px;text-align:center">
									...
									<!-- 新增费用弹框 -->
									<el-dialog title="新增费用" width="25%" :visible.sync="dialog.dialogaddFee">
										<el-form label-width="80px" label-position="left">
											<el-form-item required label="收费时间" prop="shoukuanDate">
												<el-date-picker clearable size="small" style="width: 200px" v-model="addfeeInfo.shoukuanDate" type="date"
												 value-format="yyyy-MM-dd" placeholder="选择收款时间">
												</el-date-picker>
											</el-form-item>
											<el-form-item required label="费用编号" prop="num">
												<el-input v-model="addfeeInfo.num" placeholder="请输入费用编号" />
											</el-form-item>

											<el-form-item required label="费用金额" prop="constractNum">
												<el-input v-model="addfeeInfo.amount" placeholder="请输入合同编号" />
											</el-form-item>
											<el-form-item required label="付款方式" prop="payMethod">
												<el-input v-model="addfeeInfo.payMethod" placeholder="请输入付款方式" />
											</el-form-item>
											<el-form-item required label="费用类型" prop="type">
												<el-input v-model="addfeeInfo.type" placeholder="请输入费用类型" />
											</el-form-item>
                        ...
                        />
											...
											<el-form-item required label="收款人" prop="reciever">
												<el-input v-model="addfeeInfo.reciever" placeholder="请输入收款人" />
											</el-form-item>
											<el-form-item label="备注" prop="updateDate">
												<el-input type="textarea" :rows="3" placeholder="请输入内容" v-model="addfeeInfo.remark"></el-input>
												<!-- <el-date-picker
                          clearable
                          size="small"
                          style="width: 200px"
                        ...
                        >
										...
										<div slot="footer" class="dialog-footer">
											...
											<el-button type="primary" @click="submitAddfee">确 定</el-button>
										</div>
									</el-dialog>
								</div>
							</div>
					...
					<el-tab-pane label="合同附件" name="third">
						<div class="main">
							<div class="main_left" style="width:100%">
								<div class="main_content_top">
									...
									<el-button v-if="checkStatus !== '2'" class="fr" size="small" type="primary" style="margin-top:25px" @click="dialog.dialogAddattachement = true">新增附件</el-button>
						...
						<!-- 新增附件弹框 -->
						<el-dialog title="合同审核" width="40%" :visible.sync="dialog.dialogAddattachement">
					...
					<el-tab-pane label="开店信息" name="fourth">
						<div class="main">
							<div class="main_left" style="width:100%">
								<div class="main_content_top">
									<el-button v-if="checkStatus !== '2'" size="small" type="primary" class="fr" style="margin:25px 0" @click="dialog.dialogopenshop = true">开店</el-button>
						...
						<el-dialog title="开店" width="40%" :visible.sync="dialog.dialogopenshop">
							<el-form label-width="80px">
								...
								<el-form-item required label="备注信息">
									<el-input placeholder="请输入" v-model="addshop.remark"></el-input>
								</el-form-item>
							</el-form>
							<span slot="footer" class="dialog-footer">
			...
			<el-dialog title="合同审核" :visible.sync="dialog.dialogcheck" width="500px">
				...
				<el-date-picker value-format="yyyy-MM-dd" v-model="contractList.checkDate" type="date" placeholder="选择日期">
				</el-date-picker>
				<div slot="footer" class="dialog-footer">
			...
			<!-- 反审核弹框 -->
			<el-dialog title="合同反审核" width="30%" :visible.sync="dialog.dialoguncheck">
				<tr>
					<td><i class="el-icon-message-solid" style="font-size:70px"></i></td>
					<td>
			...
			<el-dialog title="合同续签" width="40%" :visible.sync="dialog.dialogextend">
				<el-form label-width="120px">
					...
					<el-form-item required label="签约日期">
						<el-date-picker v-model="contentRenew.signDate" type="date" placeholder="选择日期">
						</el-date-picker>
					</el-form-item>
					<el-form-item required label="合同开始时间">
						<el-date-picker v-model="contentRenew.beginDate" type="date" placeholder="选择日期">
						</el-date-picker>
					</el-form-item>
					<el-form-item required label="合同结束时间">
						<el-date-picker v-model="contentRenew.endDate" type="date" placeholder="选择日期">
						</el-date-picker>
					</el-form-item>
					...
					<el-form-item required label="加盟费">
						<el-input v-model="contentRenew.fee.jiamengjiameng" placeholder="请输入"></el-input>
					</el-form-item>
					<el-form-item required label="运营管理费">
						<el-input v-model="contentRenew.fee.yunying" placeholder="请输入"></el-input>
					</el-form-item>
					...
					<div class="main_title">备注信息</div>
					<el-input type="textarea" :rows="3" v-model="contentRenew.remark"></el-input>
			...
			<!-- 转移弹框 -->
			<el-dialog title="合同转移" width="30%" :visible.sync="dialog.dialogtransfor">
